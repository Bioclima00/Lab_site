...
export default function MeiDuProfile() {
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          {/* 左侧个人信息面板 - 采用代表“热应激/城市热环境”的玫瑰红至橙红渐变 */}
          <div className="w-full md:w-1/3 bg-gradient-to-br from-rose-900 via-red-700 to-orange-600 text-white p-10 flex flex-col items-center md:items-start text-center md:text-left relative overflow-hidden">
            ...
            <div className="relative w-full max-w-[14rem] aspect-[14/18] rounded-2xl overflow-hidden border border-white/20 mb-8 shadow-2xl mx-auto md:mx-0 bg-white/10 backdrop-blur-sm z-10">
              <img 
                src="/people/mei-du.jpg" 
                alt="Mei Du" 
                className="w-full h-full object-cover object-[50%_0%]" 
              />
            </div>
            
            <h1 className="relative z-10 text-3xl font-bold tracking-tight mb-2">Mei Du</h1>
            ...
            <div className="relative z-10 flex space-x-4 mb-10 justify-center md:justify-start w-full">
              <a href="mailto:example@tsinghua.edu.cn" className="text-orange-100 hover:text-white transition-colors" title="Email">
            ...
            {/* 严格按照 markdown 提取研究兴趣，并补充了你提到的人体热应激 */}
            <div className="relative z-10 w-full">
              ...
              <ul className="space-y-3 text-sm font-medium text-orange-50">
                <li>Human Heat Stress</li>
                <li>Urban Heat Islands</li>
                <li>Nature-based Solutions</li>
                <li>Climate Mitigation Strategies</li>
              </ul>
            </div>
          </div>
          ...
          <div className="w-full md:w-2/3 p-10 md:p-16">
            ...
            <section className="mb-12">
              ...
              <div className="prose prose-slate max-w-none text-gray-600 leading-relaxed space-y-6">
                <p>
                  Mei Du is currently a PhD candidate in Environmental Science and Engineering at the Shenzhen International Graduate School (SIGS), Tsinghua University.
                </p>
                <p>
                  Her research is primarily rooted in the field of the urban thermal environment, with a specific focus on human heat stress. Her broader research interests encompass urban heat islands, nature-based solutions, and climate mitigation strategies aimed at building more resilient urban ecosystems.
                </p>
              </div>
            </section>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="border-l-2 border-slate-200 pl-4 relative">
                  ...
                  <h4 className="text-md font-bold text-gray-900">M.S. in Resources and Environmental Engineering</h4>
                  <p className="text-sm text-gray-500">University of Chinese Academy of Sciences (UCAS) / Institute of Urban Environment, CAS | 2020.09 - 2023.06</p>
                </div>
                {/* 本科 */}
                <div className="border-l-2 border-slate-200 pl-4 relative">
                  <div className="absolute w-2 h-2 bg-slate-400 rounded-full -left-[5px] top-2"></div>
                  <h4 className="text-md font-bold text-gray-900">B.S. in Landscape Architecture</h4>
                  <p className="text-sm text-gray-500">Hunan Agricultural University | 2016.09 - 2020.06</p>
                </div>
              </div>
            </section>
